...
[
  {
    ...
    expected: [
      { type: "ok", tagnum: 1, textCode: undefined, text: "LOGIN completed" },
    ],
    what: "Tagged OK",
  },
  {
  ...
  {
    source: ["+ idling", CRLF],
    expected: [{ textCode: undefined, text: "idling" }],
    what: "Continuation",
  },
  {
    source: ["+ [ALERT] idling", CRLF],
    expected: [{ textCode: "ALERT", text: "idling" }],
    what: "Continuation with text code",
  },
  {
    source: ["+", CRLF],
    expected: [{ textCode: undefined, text: undefined }],
    ...
    expected: [
      {
        ...
        textCode: undefined,
        text: {
          personal: [{ prefix: "", delimiter: "/", extensions: undefined }],
          other: [{ prefix: "~", delimiter: "/", extensions: undefined }],
          shared: [
            { prefix: "#shared/", delimiter: "/", extensions: undefined },
            { prefix: "#public/", delimiter: "/", extensions: undefined },
            { prefix: "#ftp/", delimiter: "/", extensions: undefined },
            { prefix: "#news.", delimiter: ".", extensions: undefined },
          ],
        },
      },
    ],
    ...
    expected: [
      {
        ...
        num: undefined,
        textCode: undefined,
        text: ["\\Answered", "\\Flagged", "\\Deleted", "\\Seen", "\\Draft"],
      },
    ],
    what: "Flags",
  },
  {
    ...
    expected: [
      { type: "search", num: undefined, textCode: undefined, text: [2, 3, 6] },
    ],
    what: "Search",
  },
  {
  ...
  },
  {
    ...
    expected: [
      { type: "ok", num: undefined, textCode: undefined, text: undefined },
    ],
  ...
  },
  {
    ...
    expected: [
      { type: "exists", num: 18, textCode: undefined, text: undefined },
    ],
  ...
  },
  {
    ...
    expected: [
      { type: "recent", num: 2, textCode: undefined, text: undefined },
    ],
  ...
  },
  {
    ...
    expected: [
      { seqno: 12, which: "HEADER", size: 342 },
      { type: "fetch", num: 12, textCode: undefined, text: {} },
    ],
    ...
    expected: [
      {
        ...
        text: {
          ...
          envelope: {
            ...
            to: [{ name: null, mailbox: "imap", host: "cac.washington.edu" }],
            cc: [
              { name: null, mailbox: "minutes", host: "CNRI.Reston.VA.US" },
  ...
  },
  {
    ...
    expected: [{ type: "ok", tagnum: 1, textCode: undefined, text: "" }],
